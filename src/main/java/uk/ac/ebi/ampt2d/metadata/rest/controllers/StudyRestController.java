...
public class StudyRestController implements ResourceProcessor<RepositoryLinksResource> {
    ...
    @ApiImplicitParams({
            @ApiImplicitParam(name = "analyses.referenceSequence.name", value = "ReferenceSequence's name", dataType = "string",
                    paramType = "query", example = "grch37"),
            @ApiImplicitParam(name = "analyses.referenceSequence.patch", value = "ReferenceSequence's patch number", dataType = "string",
