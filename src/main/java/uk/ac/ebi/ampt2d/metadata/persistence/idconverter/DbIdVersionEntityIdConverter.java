...
public class DbIdVersionEntityIdConverter implements Converter<String, DbIdVersionEntityId> {

    @Override
    public DbIdVersionEntityId convert(String id) {
        DbIdVersionEntityId dbIdVersionEntityId;
        try {
