...
public interface EnaObjectQuery {
    ...
    String SAMPLE_QUERY = "SELECT ANALYSIS_SAMPLE.SAMPLE_ID, SAMPLE.SAMPLE_XML FROM ANALYSIS_SAMPLE INNER JOIN " +
            "SAMPLE ON ANALYSIS_SAMPLE.SAMPLE_ID = SAMPLE.SAMPLE_ID WHERE ANALYSIS_SAMPLE.ANALYSIS_ID = :accession";
}
